# StatBench Dataset Plan

Complete inventory of OpenIntro/IMS datasets, mapped to StatBench page types and IMS chapters.

## Legend

- **Status**: ✅ = bundled in StatBench, ☐ = not yet added
- **StatBench type**: which `type` value in datasets.json / which page(s) can use it
